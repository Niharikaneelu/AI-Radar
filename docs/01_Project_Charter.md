...
3. Problem Statement
Today, AI news is scattered across numerous websites, blogs, research portals, and government publications.
Students, faculty members, researchers, and professionals spend significant time searching for relevant AI news.
Most websites either:
•	publish every news article regardless of relevance,
•	require manual updates,
•	lack intelligent categorization,
•	or provide no concise summaries.
Department websites and digital signage systems also rely on manual content updates, making information quickly become outdated.
There is currently no lightweight platform dedicated to automatically collecting, filtering, and organizing AI-related news into an easily consumable format.
4. Proposed Solution
